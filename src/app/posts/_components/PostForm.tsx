...
// `<div>` rather than `<label>`: the cover-image field contains a
// `<input type="file">` alongside the preview, and wrapping that in a
// `<label>` made clicks on adjacent padding pop the native file picker.
